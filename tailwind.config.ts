    ...
    extend: {
      ...
      keyframes: {
        ...
        falling: {
          ...
          "10%": { opacity: "1" },
          "20%": { transform: "translateY(-450px) rotate(45deg)" },
          "40%": { transform: "translateY(-450px) rotate(90deg)" },
          "60%": { transform: "translateY(450px) rotate(180deg)" },
          "80%": { transform: "translateY(-450px) rotate(180deg)" },
          "100%": {
